    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('metadata', models.JSONField(default=dict, help_text='Champs supplémentaires : dépendances, émotions, contraintes…')),
        ...
        migrations.AlterField(
            model_name='jaredlog',
            name='tags',
            field=models.CharField(blank=True, help_text='Mots-clés ou catégories (séparés par des virgules)', max_length=255),
        ),
    ]
