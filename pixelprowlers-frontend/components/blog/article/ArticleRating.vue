...
/** Définition stricte des clés autorisées pour ratings */
type CriterionKey = 'impact' | 'clarity' | 'utility'

/** Props pour récupérer le slug de l’article */
const props = defineProps<{ slug: string }>()

/** Liste typée des critères */
...
/** Active le bouton si au moins une note est renseignée */
...
/**
 * Soumet le feedback puis ouvre le drawer
 */
